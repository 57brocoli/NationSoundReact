...
import Marker from './SousComposants/Marker';
...
const MapComponent = ({screenSize}) => {
    ...
    const [lat, setLat] = useState(43.63156)
    const [lng, setLng] = useState(3.84155)
        ...
        <div className='d-flex justify-content-center align-items-center doc'>
            {isLoaded ?
                ...
                >
                    ...
                    >
                        {showEntrer && 
                            <div className='boxEntrer' style={{position:'absolute', bottom:20, left:20, width:320, height:'10%' }}>
                                <h3>Entrer</h3>
                                <p>L'entré du festival</p>
                            </div>
                        }
                    </MarkerF>
                        ...
                        .map((lieu)=>{
                            return(
                                <MarkerF 
                                    ...
                                    icon={{url:`${imageLieu.uri}${lieu.featuredImage}`, scaledSize:{width:40, height:40}}} 
